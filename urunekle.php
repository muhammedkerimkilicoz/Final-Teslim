...
<!DOCTYPE html>
<html lang="tr">
<form action="onay.php" method="POST" enctype="multipart/form-data">
<head>
	<title>Mami</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Ürün Kategori">
						<input class="input100" type="text" name="urunkategori" placeholder="Ürün Kategori">
					...
					<div class="wrap-input100 validate-input" data-validate="fileUp">
						<input class="input100" type="file" name="resim" placeholder="resim">
						<span class="focus-input100" data-placeholder="&#xf301;"></span>
					</div>
