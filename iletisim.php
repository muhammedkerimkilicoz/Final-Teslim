						...
						<!DOCTYPE html>
<html lang="tr">
<form action="iletisimonay.php" method="POST">
	<head>
		<meta charset="utf-8">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						<li class="active"	><a href="anasayfa.php">Anasayfa</a></li>
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="ad" placeholder="Adı">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="soyad" placeholder="Soyadı">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="input" type="text" name="urunkod" placeholder="Ürün Kodu">
							</div>
							<button>
								<div class="primary-btn order-submit">Teklif Al</a></div>
							</button>
						</div>
